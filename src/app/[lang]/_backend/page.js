    ...
    <div className="flex flex-col bg-suloke-yellow w-full gap-y-14 px-5 pt-32 pb-14 items-center">
      <div className="md:w-4/5 lg:w-1/2 gap-y-14 md:gap-y-20 lg:gap-y-24">
        <div className="flex flex-col gap-y-3 md:gap-y-4 lg:gap-y-5 lg:mb-8">
          {" "}
          {/* Intro */}
          <h1 className="text-center pb-6 lg:mb-8">BACKEND DEVELOPMENT</h1>
          <p className="px-2">
            Our team has experience in delivering complex and demanding backend
            solutions for a variety of customers. We have created complete
            pipelines for eCommerce and large big data gathering and analysis
            operations; creating RESTful API´s and integrating Computer
            Vision(YOLO) into data analysis.
          </p>
          <p className="px-2">
            We provide you fast implementation of reliable and lasting
            backend-solutions, organizing and enhancing your business.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-y-10 pb-10">
          {" "}
          {/* Contact */}
          <ContactCard color={"bg-suloke-yellowlight"} lang={lang} />
        </div>
      </div>
    </div>
  );
